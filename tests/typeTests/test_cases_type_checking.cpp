...
BOOST_AUTO_TEST_CASE(TypeDoNOTMatchExp) {testTypeCheckString("int x = false;\n", TestingOutcome::FAILED);}
...
// Test Return
// TODO test more! 
BOOST_AUTO_TEST_CASE(ReturnFuncFalse) {testTypeCheckString("int f() { return false;}", TestingOutcome::FAILED);}
